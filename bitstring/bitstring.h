...
pbitstring_t bitstring_new_uint(uint_t val, unsigned int size, order_t byte_order, order_t bit_order);
pbitstring_t bitstring_new_sint(sint_t val, unsigned int size, order_t byte_order, order_t bit_order);
pbitstring_t bitstring_new_fp(fp_t val, unsigned int size, fprep_t fp_rep, order_t byte_order, order_t bit_order);
...
void conv_byte_bit_order(char* pval, unsigned int size_bytes, order_t byte_order, order_t bit_order);
